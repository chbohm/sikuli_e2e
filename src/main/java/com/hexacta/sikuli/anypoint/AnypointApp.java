...
public class AnypointApp extends ChromeApp {
	...
	protected AnypointApp(DesktopWindow w) {
		super(w);
	}



	public static AnypointApp create(String url) {
		DesktopWindow w = ChromeApp.init();
		AnypointApp app = new AnypointApp(w);
		app.gotoUrl(url);
	...
	public void start() {
		wait("anypoint/manage_api_button.png", 3.0);
		click("anypoint/manage_api_button.png");
		wait("anypoint/create_new_api_button.png", 1.0);
		click("anypoint/create_new_api_button.png");
		wait("anypoint/asset_name_txt.png", 1.0);
		paste("anypoint/asset_name_txt.png", "test");
		Region assetName= this.find("anypoint/asset_name_txt.png");
		Region assetType = assetName.offset(0, 18);
		assetType.highlight();
		assetType.paste("SOAP API - WSDL");
		click("anypoint/choose_file_button.png");
...
//	}
	...
	public static void main(String[] args) throws IOException {
		AnypointApp app = AnypointApp.create("https://anypoint.mulesoft.com/apimanager/creditone/#/organizations/35948028-ba40-4ccc-bf9d-7a25bc819004/environments/8121f8c8-217c-4c59-a887-d8194fd8df81/apis");
		app.start();
